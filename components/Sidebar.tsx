...
const menus = [
  { name: "Moradores", href: "/moradores", roles: ["sindico", "admin"] },
  { name: "Finanças", href: "/financas", roles: ["sindico", "admin"] },
  { name: "Aluguel de espaço", href: "/aluguel", roles: ["morador", "sindico", "admin"] },
  { name: "Portaria", href: "/portaria", roles: ["sindico", "admin"] },
  { name: "Compras", href: "/compras", roles: ["admin"] },
  { name: "Estoque", href: "/estoque", roles: ["admin"] },
  { name: "Prestadores de Serviço", href: "/prestadores", roles: ["sindico", "admin"] },
  { name: "Relatórios", href: "/relatorios", roles: ["sindico", "admin"] },
];
